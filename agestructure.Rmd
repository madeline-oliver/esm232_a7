...
# fertility rates
F1 = 0.0
F2 = 0.25/2 # have to divide by two because only women are fertile
F3 = 0.5/2
F4 = 0.25/2
...
ini = c(235,224,182,124,95,69,42,24,6) # doing this in millions
ndecades = 15
...
Sensitivity Of
  * total populatin after 3 decades
  
Assume we are looking at microbial population and monthly fertility and mortality rates; but looks the same as china example
